...
const NavigationPage = () => {
    ...
    const navigationLinks2 = [

        {
            ...
            links: ["Документи закладу", "Накази", 'Освітні навчальні програми', 'Положення',  "Стратегія розвитку ЗО",]

        },
        {
            name: 'Навч-виховні роботи',
            links: ["Виховна робота", "Дистанційне навчання", 'ДПА/НМТ', 'Методичні роботи', 'НУШ']
