    ...
    return (
        <div className='w-full h-full bg-prepage  flex items-center justify-center '>
            <div className='w-full h-94 flex flex-col  items-center justify-around'>
                ...
                <h3 data-aos="fade-up" className='text-5xl font-medium'>Шклівський ЗЗСО І-ІІІ ступенів ім. Мар'яна Корчака</h3>
                <p data-aos="fade-up" className='text-3xl'>– навчальний заклад з українською мовою навчання, який включає три ступені освіти:</p>
                <div className='w-2/5 h-1/5 flex flex-col items-center justify-between'>
                    <li data-aos="fade-up" className='text-3xl font-mono'>1-4 класи–початкова школа</li>
                    <li data-aos="fade-up" className='text-3xl font-mono'>5 – 9 класи –основна школа</li>
                    <li data-aos="fade-up" className='text-3xl font-mono'>10-11 класи– старша школа</li>
                </div>
