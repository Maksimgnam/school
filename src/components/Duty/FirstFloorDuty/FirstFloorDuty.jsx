...
const FirstFloorDuty = () => {

    const dutyFirstFloorTeachers = [
        { id: 0, name: "Василь Олегович Павленко", email: "John@gmail.com", dateToDuty: "2024-04-23" },
        { id: 1, name: "Марія Василівна Коваленко", email: "Evan@gmail.com", dateToDuty: "2024-04-27" },
        { id: 2, name: "Олена Миколаївна Сидоренко", email: "Jaret@gmail.com", dateToDuty: "2024-04-16" },
        { id: 3, name: "Іван Петрович Ковальов", email: "Lous@gmail.com", dateToDuty: "2024-04-20" },
    ]
  return  dutyFirstFloorTeachers.map((item)=>{
