        ...
        <div className='w-full h-auto min-h-100vh bg-prepage  flex items-center justify-center  '>
            <div className='w-full h-auto  min-h-100vh flex flex-col  items-center justify-around p-8'>
                ...
                <div className='w-full h-auto flex flex-wrap items-center justify-center '>
                    ...
                    <div className='w-auto h-auto  flex flex-col m-4 '>
                        <div data-aos="fade-up" className='w-auto  flex'>
                            <p className='text-3xl pb-2.5 '>Контактна інформація</p>
                        </div>
                        ...
                        <div data-aos="fade-up" className='w-auto h-10 flex items-center'>
                            ...
                            <p className='text-2xl font-mono relative left-1'>0-3259-5-05-48</p>
                        </div>
                        <div data-aos="fade-up" className='w-auto h-10 flex items-center'>
                            <div className='w-8 h-8 flex items-center justify-center'>
                                <img className='w-6 h-6' src={email} alt="" />
                            </div>
                            <p className='text-2xl font-mono relative left-1'>shkolashklo@gmail.com</p>
                        </div>
                        <div data-aos="fade-up" className='w-auto h-10 flex items-center'>
                            <div className='w-8 h-8 flex items-center justify-center'>
                                <img className='w-6 h-6' src={map} alt="" />
                            </div>
                            <p className='text-2xl font-mono relative left-1'>смт Шкло. вул Шевченка, 1</p>
                        </div>
                ...
                <div className='w-auto h-auto'>
                    <Link to='/enroll-child-in-1-grade'>
                        <button data-aos="fade-up" className='w-48 h-14 bg-black rounded m-2 mt-0'>
